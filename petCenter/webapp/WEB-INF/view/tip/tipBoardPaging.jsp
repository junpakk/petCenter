...
%>
		<a href="<%=url %>?<%=str %>curPage=1">
			<img src="/petCenter/img/map/arrowLeft.png" width="20" height="15"/></a>&nbsp;
		<a href="<%=url %>?<%=str %>curPage=<%=linkPage%>">
			<img src="/petCenter/img/map/arrowLeft1.png" width="20" height="15"/></a>
<%
	}else{
%>			
		<img src="/petCenter/img/map/arrowLeft.png" width="20" height="15"/></a>&nbsp;
...
<%
	...
	linkPage++;
	logger.info("lilnkPage++ >>> "+linkPage);
...
%>
		<a href="<%=url%>?<%=str%>curPage=<%=linkPage%>">
		<img src="/petCenter/img/map/arrowRight1.png" width="20" height="15"/></a>&nbsp;
		<a href="<%=url%>?<%=str%>curPage=<%=pageCount%>">
		<img src="/petCenter/img/map/arrowRight.png" width="20" height="15"/></a>
...
%>
		<img src="/petCenter/img/map/arrowRight1.png" width="20" height="15"/>&nbsp;
		<img src="/petCenter/img/map/arrowRight.png" width="20" height="15"/>
<%
	}
%>
	</p>